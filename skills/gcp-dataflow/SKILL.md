...
description: >
  ...
  Key capabilities include: Project setup for Java/Python/Go, Flex Template
  configuration (with Cloud Build support), and in-depth diagnostics for
  streaming job health, bottlenecks, and autoscaling.
...
4.  **Analysis**:
    ...
    *   For Streaming Jobs
        *   Overall Job Health: YOU MUST refer to
            [streaming_job_health](references/streaming_job_health.md) to
            analyze overall streaming job health.
